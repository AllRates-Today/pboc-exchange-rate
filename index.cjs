'use strict';
// People's Bank of China exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/pboc';
...
/** Latest rate for one pair, e.g. getRate('USD', 'CNY', { apiKey }). */
